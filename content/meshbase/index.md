...
heroImage: "/api/content-image/meshbase/meshbase_complete.jpg"
figures:
  - src: "/api/content-image/meshbase/meshbase_powder-coat.jpg"
    caption: "Case powder coat"
    id: "FIG-001"
  - src: "/api/content-image/meshbase/meshbase_case-milling1.jpg"
    caption: "Connector hole milling"
    id: "FIG-002"
  - src: "/api/content-image/meshbase/meshbase_case-milling2.jpg"
    caption: "Connector hole boring (ethernet connector only)"
    id: "FIG-003"
  - src: "/api/content-image/meshbase/meshbase_electronic-fitup.jpg"
    caption: "Electronics fitup"
    id: "FIG-004"
  - src: "/api/content-image/meshbase/meshbase_connectors1.jpg"
    caption: "IP-67 Ethernet & USB-C data connectors"
    id: "FIG-005"
  - src: "/api/content-image/meshbase/meshbase_connectors2.jpg"
...
This node is based on the [Luckyfox Lyra Ultra](https://wiki.luckfox.com/Luckfox-Lyra/Luckfox-Lyra-Ultra/), which is a highly integrated linux SBC that can be powered over PoE or USB-C. Connected over I2C is an E22P 1 watt LoRa modem on a hat designed by the wonderful [wehooper4](https://github.com/wehooper4/Meshtastic-Hardware/tree/main/Luckfox%20Ultra%20Hat) (FIG-004). The antenna is a fairly standard [Alfa AOA-915-5ACM](https://www.alfa.com.tw/products/aoa-915-5acm?variant=36473963020360), though this may be changed to allow for more flexible antenna pointing. All components are placed inside a [McMaster 4270N14](https://www.mcmaster.com/4270N14/) EMI enclosure, which is NEMA 4x and IP-67 rated, along with a frequency reduction of 70 dB @ 1 GHz (FIG-001). The case was custom powdercoated and modified to fit the IP-67 rated [RJ-45](https://www.mouser.com/ProductDetail/200-SCRESG00.25DC5E), [USB-C](https://www.mouser.com/ProductDetail/200-BPCU-CS-025-UC-P), and [N-type](https://store.rokland.com/products/uflipex-ipx-mini-pci-to-n-female-bulkhead-pigtail-cable-extension-rg178) connectors (FIG-002, FIG-003, FIG-005, FIG-006). 
## Status
