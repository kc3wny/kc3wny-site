...
type: "Project"
description: "A student-build 2U technology demonstrator launching Transporter 18!"
...
## Roles
- **Ground Station Software Project Lead**: Sept 2023-March 2024
- **Mission Control Lead**: Must operate autonomously beyond manual puck loading; human interference during play incurs penalties
...
Improvements to our existing UHF ground station was also a major contribution. Issues included unresolved ground loops, a high noise floor, intermittent rotator outages, and severe signal fading during inclimate weather. The rewiring of our UHF radio, improved single point grounding, and replacement cable harnesses resolved most of these issues (FIG)(FIG). Signal fading was isolated to a failing LNA and N-type connector mounted to the antenna, suffering from water ingress and severe corrosion. Despite attempts to repair both components, they were instead replaced to resolve the problem. (FIG)

My final major project was the design of the ground control and data storage architecture laid out here (FIG). While it has been modified and expanded since 2024, this design is largely still in place.